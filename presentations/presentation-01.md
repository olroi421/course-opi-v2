...
2. **Security Misconfiguration** - неправильна конфігурація
3. **Software Supply Chain Failures** - нове! збої в ланцюжку постачання ПЗ
4. **Cryptographic Failures** - слабке шифрування
